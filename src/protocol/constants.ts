...
export const PARAM_LABELS: Record<string, string> = {
  ...
  // River 3 protobuf fields
  sys_status: 'System Status',
  lcd_soc: 'Display SoC',
  full_cap_mins: 'Full Cap (min)',
  remain_mins_1: 'Remain Time 1',
  remain_mins_2: 'Remain Time 2',
  output_count: 'Output Count',
  ac_enabled: 'AC Enabled',
  dc_enabled: 'DC Enabled',
  power_factor: 'Power Factor',
  charge_watts: 'Charge Power',
  full_cap_wh: 'Full Capacity',
  total_out_kwh: 'Total Out',
  total_in_kwh: 'Total In',
  charge_limit: 'Charge Limit',
  discharge_limit: 'Discharge Limit',
  solar_watts: 'Solar Power',
  inv_temperature: 'Inverter Temp',
  temp_sensor_1: 'Temp 1',
  temp_sensor_2: 'Temp 2',
  temp_sensor_3: 'Temp 3',
...
export const PARAM_GROUPS: Record<string, string[]> = {
  ...
  'Power I/O': ['watts_out_sum', 'watts_in_sum', 'charge_watts', 'solar_watts', 'inv_input_watts', 'inv_output_watts', 'inv_out_vol', 'ac_enabled', 'cfg_ac_enabled', 'dc_enabled', 'cfg_ac_xboost'],
  'USB/DC': ['usb1_watts', 'usb2_watts', 'qc1_watts', 'qc2_watts', 'usbc1_watts', 'usbc2_watts', 'dc_out_state', 'output_count'],
  'BMS': ['bms_soc', 'bms_voltage', 'bms_current', 'bms_temp', 'bms_cycles', 'bms_soh'],
  'Temperature': ['temperature', 'inv_temperature', 'temp_sensor_1', 'temp_sensor_2', 'temp_sensor_3', 'temp_sensor_4'],
  'Counters': ['total_out_kwh', 'total_in_kwh', 'total_out_kwh_2', 'total_in_kwh_2'],
